...
DOMAIN = "openai_custom_conversation"
LOGGER: logging.Logger = logging.getLogger(__package__)

DEFAULT_CONVERSATION_NAME = "OpenAI Custom Conversation"
DEFAULT_AI_TASK_NAME = "OpenAI Custom AI Task"
DEFAULT_NAME = "OpenAI Custom Conversation"
